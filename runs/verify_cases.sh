...
echo "--- apply templated namelists (AD/FN from v2 spin-up = FUN off; TR from v6 FUN-P transient)"
$PY /home/braghiere/ELM-FUN-2022-corrigendum/runs/apply_namelists.py $CR $RR ad $AD
$PY /home/braghiere/ELM-FUN-2022-corrigendum/runs/apply_namelists.py $CR $RR fn $FN $AD
$PY /home/braghiere/ELM-FUN-2022-corrigendum/runs/apply_namelists.py $CR $RR tr $TR $AD $FN
...
echo "--- normalized diff vs the published templates (paths/casenames/paramfile stripped); empty = identical"
B=/home/braghiere/ELM-FUN-2022-corrigendum/runs/v6_baseline_namelists; B2=/home/braghiere/ELM-FUN-2022-corrigendum/runs/v2_spinup_namelists
...
diff <(norm $B2/fix_global_v2_f19_f19_ICB1850CNRDCTCBC_ad_spinup.user_nl_clm) <(norm $CR/$AD/user_nl_clm) && echo "  AD identical"
diff <(norm $B2/fix_global_v2_f19_f19_ICB1850CNPRDCTCBC.user_nl_clm)         <(norm $CR/$FN/user_nl_clm) && echo "  FN identical"
